...
public class SimConfig {
    ...
    /**
     * Intervalle de déplacement des unités
     */
    public static final long INTERVALLE_DEPLACEMENT_TICKS = 300;

    /**
     * Intervalle d’incrémentation d’une année pour les autres cartes (en ms)
     */
    public static final long INTERVALLE_TEMPS_ANNEE_CARTE_TICKS = 1000;
