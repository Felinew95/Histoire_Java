...
public class ChartManager {
    ...
    public void updateRessourcesPieChart(String civName, Economie economie) {
        DefaultPieDataset dataset = datasetPieParCiv.computeIfAbsent(civName, k -> new DefaultPieDataset());
    ...
    public void updateRelationsBarChart(String civName, ArrayList<Relation> relations) {
        DefaultCategoryDataset dataset = datasetRelationsParCiv.computeIfAbsent(civName,k -> new DefaultCategoryDataset());
        dataset.clear();
