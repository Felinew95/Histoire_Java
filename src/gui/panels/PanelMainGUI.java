...
public class PanelMainGUI extends JPanel {
    ...
    private void initVariables() {
        ...
        Armee armee = SimFactory.buildArmee(chefRepository.getKersirActuel(anneeDebutSim), 10000, 300, 10, 80f);

        Civilisation civilisation = SimFactory.buildCivilisation(chefRepository.getKonungrActuel(anneeDebutSim), SimFactory.buildEconomie(), armee, pop
