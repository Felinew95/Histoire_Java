...
public class PanelMainGUI extends JPanel {
	...
	private void initVariables() {
    	this.simulation = new Simulation(750, SimFactory.buildMap(), SimFactory.buildCivilisation("", null, null, null, null, null, ""), MobileBuilder.buildMobileManagerLindsfarne());
    	this.paintStrategy = new PaintStrategy();
    	
    	Ile lidsfarne = IleBuilder.buildLindsfarne();
		this.simulation.getCarte().ajouterIle(lidsfarne);
    	
        this.panelSim = new PanelSim(this.simulation.getCarte(), paintStrategy, this.simulation.getMobileManager());
