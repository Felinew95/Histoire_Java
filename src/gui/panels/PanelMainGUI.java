...
public class PanelMainGUI extends JPanel {
	...
	private void initPanelNarration() {
        ...
        Dimension dimTexteNarration = new Dimension(180, 350);
	...
	private void initVariables() {
    	this.simulation = new SimulationManager(780, MapFactory.buildCarte(), SimFactory.buildCivilisation(
                "", null, null, SimFactory.buildPopulation(50000, RANDOM.nextInt(0, 10), "HOMME", RANDOM.nextFloat(), RANDOM.nextFloat()), null, null, ""),
