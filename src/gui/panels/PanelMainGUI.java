...
public class PanelMainGUI extends JPanel {
    ...
    private class StatsPanel extends JPanel {
        ...
        JLabel labelValeurNombreGuerriers = new JLabel("0");

        JLabel labelNombreNavires = new JLabel("Nombre de navires : ");
        JLabel labelValeurNombreNavires = new JLabel("0");

        JLabel labelTypeRegime = new JLabel("Type de régime :");
        JLabel labelValeurTypeRegime = new JLabel("Indéfini");

        JLabel labelNombreHabitants = new JLabel("Nombre d'habitants : ");
        JLabel labelValeurNombreHabitants = new JLabel("0");

        JLabel labelNomReligion = new JLabel("Religion : ");
        JLabel labelValeurNomRegion = new JLabel("Indéfini");

        JProgressBar barRichesse = new JProgressBar(0, 100000);
        JProgressBar barEtatArmee = new JProgressBar(0, 100);
        JProgressBar barInfluenceReligion = new JProgressBar(0, 100);
