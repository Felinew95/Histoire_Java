...
public class MainGUI extends JFrame implements Runnable {
    ...
    public void run() {
        ...
        while (!estQuitter && sim.getAnneeActuelle() < SimConfig.ANNEE_FIN_SIM) {
            ...
            for (SimulationManager simAdverse : panelMainGUI.getSimulationManagersAdverses()) {
            ...
            Civilisation civAffichee = panelMainGUI.getPovActuel();
    ...
    private void rafraichirStatsInterface(Civilisation civ) {
        ...
        if (civ.getPopulation() != null) {
            panelMainGUI.getLabelValeurNombreHabitants().setText(
        ...
        if (civ.getEconomie() != null) {
            ...
            JProgressBar barRichesse = panelMainGUI.getBarRichesse();
        ...
        if (armee != null) {
            panelMainGUI.getLabelValeurNombreGuerriers().setText(String.valueOf(armee.getNombreGuerriers()));
            panelMainGUI.getLabelValeurNombreNavires().setText(String.valueOf(armee.getNombreNavires()));
            panelMainGUI.getBarEtatArmee().setValue((int) armee.getEtat());
            panelMainGUI.getBarEtatArmee().setString((int) armee.getEtat() + "%");
        }


        Religion religion = civ.getReligion();
        if (religion != null) {
            panelMainGUI.getLabelValeurNomReligion().setText(religion.getNom());
            panelMainGUI.getBarInfluenceReligion().setValue((int) religion.getInfluence());
            panelMainGUI.getBarInfluenceReligion().setString((int) religion.getInfluence() + "%");
        }

        
        Politique politique = civ.getPolitique();
        if (politique != null) {
            panelMainGUI.getLabelValeurTypeRegime().setText(
