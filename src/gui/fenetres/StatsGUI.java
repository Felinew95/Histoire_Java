...
public class StatsGUI extends JFrame implements Runnable {
    ...
    private JPanel createCivilisationPanel() {
        JPanel panel = createHistoricPanel("📜 CIVILISATION");
    ...
    private JPanel createBottomPanel() {
        ...
        panelBas.add(createArmeePanel(panelBas));
    ...
    private JPanel createEconomiePanel() {
        JPanel panelEconomie = createHistoricPanel("💰 ÉCONOMIE");
     ...
     */
    private JPanel createArmeePanel(JPanel panelBas) {
        JPanel panelArmee = createHistoricPanel("⚔️ ARMÉE");
        ...
        panelArmee.add(createHistoricLabel("État militaire :"));
    ...
    private JPanel createPolitiquePanel() {
        JPanel panelPolitique = createHistoricPanel("👑 POLITIQUE");
    ...
    private JPanel createPopulationPanel() {
        JPanel panelPopulation = createHistoricPanel("👥 POPULATION");
    ...
    private JPanel createReligionPanel() {
        JPanel panelReligion = createHistoricPanel("⛪ RELIGION");
    ...
    private JPanel createEvenementPanel() {
        JPanel panelEvenement = createHistoricPanel("🔥 ÉVÉNEMENT EN COURS");
     ...
     * @return JPanel stylisé
     */
    private JPanel createHistoricPanel(String title) {
    ...
    private void updateArmeePanel(Armee armee) {
        if (armee != null) {
            labelArmeeHersir.setText("Hersir : " + armee.getHersir());
    ...
    private void updateCivilisationPanel(Civilisation civilisation) {
        ...
        labelKonungr.setText("Konungr (Chef) : " + civilisation.getKonungr());
