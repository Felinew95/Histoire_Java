...
public class StatsGUI extends JFrame implements Runnable {
    ...
    public StatsGUI(ChartManager chartManager) {
        ...
        setChart(panelGraphiques, chartManager);
    ...
    private void setChart(JPanel panelGraphiques, ChartManager chartManager) {
        Dimension dim = new Dimension(350, 350);
        this.chartManager = chartManager;
        panelGraphiques.add(this.chartManager.createBarChart(dim));
        panelGraphiques.add(this.chartManager.createLineChart(dim));
        panelGraphiques.add(this.chartManager.createPieChart(dim));
    }
