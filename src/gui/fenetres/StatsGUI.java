...
public class StatsGUI extends JFrame implements Runnable {
    ...
    public StatsGUI() {
     ...
     // Les 3 graphiques en haut
        ...
        panelGraphiques.add(createBarChart(dim));
        panelGraphiques.add(createLineChart(dim));
        panelGraphiques.add(createPieChart(dim));
    ...
    private ChartPanel createBarChart(Dimension dim) {
    ...
    private ChartPanel createLineChart(Dimension dim) {
    ...
    private ChartPanel createPieChart(Dimension dim) {
