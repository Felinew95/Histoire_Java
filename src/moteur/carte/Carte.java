...
public class Carte {
    ...
    /**
     * Retourne le continent actuellement chargé sur la carte.
     *
     * @return Le {@link Continent} chargé.
     */
    ...
    /**
     * Vérifie si un bloc existe aux coordonnées spécifiées.
     *
     * @param ligne   Ligne du bloc.
     * @param colonne Colonne du bloc.
     * @return {@code true} si le bloc existe, {@code false} sinon.
     */
