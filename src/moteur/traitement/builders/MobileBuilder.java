...
public class MobileBuilder {
	...
	/**
     * Initialise le gestionnaire d'entités mobiles pour la zone de Lindisfarne.
     * 
     * <p>
     * Charge les données de position et de comportement depuis le fichier CSV dédié.
     * </p>
     * 
     * @return Un {@link MobileManager} peuplé, ou {@code null} en cas d'erreur de lecture du fichier.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour l'Europe continentale.
     * @return Un {@link MobileManager} peuplé, ou {@code null} en cas d'échec d'E/S.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour l'Islande.
     * @return Un {@link MobileManager} peuplé, ou {@code null} si le fichier CSV est introuvable ou corrompu.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour la Grande-Bretagne.
     * @return Un {@link MobileManager} peuplé, ou {@code null} en cas d'erreur système.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour la Normandie.
     * @return Un {@link MobileManager} peuplé, ou {@code null} en cas de problème d'accès au fichier.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour la Scandinavie (terres d'origine).
     * @return Un {@link MobileManager} peuplé, ou {@code null} en cas d'erreur lors de l'extraction des données.
     */
    ...
    /**
     * Initialise le gestionnaire d'entités mobiles pour le Vinland (Amérique du Nord).
     * @return Un {@link MobileManager} peuplé, ou {@code null} si le chargement échoue.
     */
