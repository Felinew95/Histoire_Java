 ...
 *
 * <p>
 * Chaque civilisation adverse reçoit son propre {@link SimulationManager}
...
public class CivilisationFactory {
     ...
     */
    public static final Color COULEUR_VIKING = new Color(0x7A3E1D);
    
    /** 
     * Couleur représentative des Anglo-Saxons (Rouge). 
     */
    public static final Color COULEUR_ANGLO_SAXONS = new Color(0xC0392B);
    
    /** 
     * Couleur représentative des Francs (Bleu). 
     */
    public static final Color COULEUR_FRANCS = new Color(0x2471A3);
    
    /** 
     * Couleur représentative des Irlandais (Vert). 
     */
    public static final Color COULEUR_IRLANDAIS = new Color(0x27AE60);
     ...
     * @return Une liste contenant les {@link SimulationManager} des Anglo-Saxons, Francs et Irlandais.
     */
     ...
     */
    public static List<SimulationManager> buildSimulationManagersAdverses(
            int anneeDebut, Carte carte) {

        List<SimulationManager> managers = new ArrayList<>();
     ...
     * @return Un {@link SimulationManager} prêt à l'emploi.
     */
    public static SimulationManager buildSimManagerAngloSaxons(int anneeDebut, Carte carte) {
     ...
     * @return Un {@link SimulationManager} prêt à l'emploi.
     */
    public static SimulationManager buildSimManagerFrancs(int anneeDebut, Carte carte) {
     ...
     * @return Un {@link SimulationManager} prêt à l'emploi.
     */
    public static SimulationManager buildSimManagerIrlandais(int anneeDebut, Carte carte) {
    ...
    public static List<Civilisation> getCivilisationsAdverses(
            List<SimulationManager> managers) {
        List<Civilisation> civs = new ArrayList<>();
        for (SimulationManager m : managers) {
