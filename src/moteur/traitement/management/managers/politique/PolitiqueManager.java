...
public class PolitiqueManager {
    ...
    public static void updatePolitique(Politique politique, Evenement evenement) {
        ...
        nouvelleStabilite = clamp(nouvelleStabilite, STABILITE_MIN, STABILITE_MAX);
        politique.setStabilite(nouvelleStabilite);

        logger.info("Ancienne stabilité : " + ancienneStabilite + ", delta : " + delta + ", nouvelle stabilité : " + nouvelleStabilite);
    ...
    private static float calculerDeltaStabilite(float stabiliteActuelle, Evenement evenement) {
        ...
        if (evenement == null) {
            logger.info("Aucun événement : delta stabilité par défaut = " + delta);
            return delta;
        }
        ...
        logger.info("Événement : " + evenement.getType() + ", delta ajusté : " + delta);
        return delta;
    }
    ...
    private static void mettreAJourOrientations(Politique politique, Evenement evenement) {
        ...
        logger.info("Orientations politiques mises à jour : Militaire = " + politique.getPolitiqueMilitaire()
                + ", Éco = " + politique.getPolitiqueEconomique()
                + ", Diplo = " + politique.getPolitiqueDiplomatique()
                + ", Régime = " + politique.getTypeRegime());
    }
