...
public class SimulationManager {
	...
	private void updateCivilisation() {
		...
		chartManager.updateRelationsBarChart(civilisation.getRelations());
	...
	private void updateArmee(Armee armee, Evenement evenement) {
		if (armee != null) {
			ArmeeManager.updateArmee(anneeActuelle, armee, evenement);
	...
	private void setKonungrActuel() {
		Konungr konungr = chefRepository.getKonungrActuel(anneeActuelle);
		if (konungr != null) {
