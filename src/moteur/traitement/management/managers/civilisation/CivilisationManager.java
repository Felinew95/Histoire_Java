...
public class CivilisationManager {
	 ...
	 */
	private long intervalleAnneeMS = SimConfig.INTERVALLE_TEMPS_ANNEE_CARTE_TICKS;
	...
	private static final Logger logger =
			LoggerUtility.getLogger(CivilisationManager.class, "html");
	 ...
	 */
	public CivilisationManager(int anneeActuelle, Carte carte, Civilisation civilisation,
	...
	private void updateMobiles() {
		...
		long intervalleDeplacementMobileMS = SimConfig.INTERVALLE_DEPLACEMENT_TICKS;
