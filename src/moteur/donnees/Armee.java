...
public class Armee {
     ...
     * @param nombreGuerriers : le nombre de de Guerriers
     */
     ...
     * @param nombreNavires : le nombre de navires
     */
     ...
     * @param techniquesMilitaire : le nombre de techniques militaire acquises
     */
