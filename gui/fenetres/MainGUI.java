...
public class MainGUI extends JFrame implements Runnable {
	...
	/**
	 * Met à jour les stats de religion dans la GUI
	 */
	private void updateStatsReligion() {
		...
		// Nom de la religion
		this.panelMainGUI.getLabelValeurNomReligion()
				.setText(religion.getNom());
	...
	/**
	 * Met à jour les stats de politique dans la GUI
	 */
