...
public class PanelMenuGUI extends JPanel implements MouseListener, MouseMotionListener {
	...
	/**
     * Gère les événements de clic de souris sur le menu.
     * 
     * <p>
     * Détermine si l'utilisateur a cliqué sur l'un des boutons (Jouer, Quitter ou Crédits)
     * en vérifiant si les coordonnées du clic se trouvent à l'intérieur de leurs zones respectives.
     * </p>
     * 
     * s@param e L'événement de souris contenant les coordonnées {@code (x, y)} du clic.
     */
	@Override
	...
	/**
     * Gère le déplacement de la souris sur le menu pour mettre à jour l'état visuel des boutons.
     * 
     * <p>
     * Cette méthode vérifie pour chaque bouton si les coordonnées du curseur se trouvent 
     * à l'intérieur de sa zone de collision. Si c'est le cas, l'état "survol" du bouton 
     * est activé, ce qui permet généralement un changement d'apparence lors du rendu suivant.
     * </p>
     * 
     * @param e L'événement de souris contenant les nouvelles coordonnées {@code (x, y)}.
     */
	@Override
