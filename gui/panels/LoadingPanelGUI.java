...
public class LoadingPanelGUI extends JPanel {
	...
	private void afficherPourcentage(Graphics2D g) {
		...
		DessinUtilitaire.afficherTexte(
				g, FONT_PERCENT, bar.getTexte() + "%",
				new Point((int) ((RoundRectangle2D) bar.getForme()).getCenterX(),
	...
	private void afficherTexteChargement(Graphics2D g) {
		...
		DessinUtilitaire.afficherTexte(
				g, FONT_LOADING, texte,
				new Point((int) bar.getForme().getBounds2D().getCenterX(),
