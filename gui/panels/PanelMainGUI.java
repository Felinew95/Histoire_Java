...
import moteur.traitement.EvenementHistoriqueBuilder;
import moteur.traitement.CarteBuilder;
import moteur.traitement.MobileBuilder;
...
public class PanelMainGUI extends JPanel {
	...
	private void initVariables() {
    	this.simulation = new Simulation(750, SimFactory.buildMap(), SimFactory.buildCivilisation("", null, null, null, null, null, ""), 
		...
		this.panelSim = new PanelSim(this.simulation.getCarte(), paintStrategy, this, this.simulation);
	...
	public void chargerEurope() {
	    Continent europe = CarteBuilder.buildEurope();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(europe);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerEurope();
	    ...
	    this.paintStrategy.setTailleBloc(SimConfig.TAILLE_BLOC_EUROPE);
	    this.paintStrategy.setEstLindsfarne(false);
	    
	    
	    this.panelSim.repaint();
	}
	
	public void chargerLindsfarne() {
	    Continent lindsfarne = CarteBuilder.buildLindsfarne();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(lindsfarne);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerLindsfarne();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
	    
	    this.paintStrategy.setTailleBloc(SimConfig.TAILLE_BLOC_CARTE);
	    this.paintStrategy.setEstLindsfarne(true);
	    
	    this.panelSim.repaint();
	}
	
	public void chargerGrandeBretagne() {
	    Continent grandeBretagne = CarteBuilder.buildGrandeBretagne();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(grandeBretagne);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerGrandeBretagne();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
	    
	    this.paintStrategy.setTailleBloc(SimConfig.TAILLE_BLOC_CARTE);
	    this.paintStrategy.setEstLindsfarne(true); // true = toute sous-carte (affiche le bouton retour)
	    
	    this.panelSim.repaint();
	}
	
	public void chargerIslande() {
	    Continent islande = CarteBuilder.buildIslande();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(islande);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerIslande();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
	...
	public void chargerNormandie() {
	    Continent normandie = CarteBuilder.buildNormandie();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(normandie);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerNormandie();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
	...
	public void chargerScandinave() {
	    Continent scandinavie = CarteBuilder.buildScandinave();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(scandinavie);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerScandinavie();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
	...
	public void chargerVinland() {
	    Continent vinland = CarteBuilder.buildVinland();
	    this.simulation.getCarte().viderContinent();
	    this.simulation.getCarte().setContinent(vinland);
	    
	    MobileManager mobileManager = MobileBuilder.buildMobileManagerVinland();
	    this.simulation.getMobileManager().setManager(mobileManager.getManager());
	    this.simulation.getCarte().placerMobiles(this.simulation.getMobileManager());
