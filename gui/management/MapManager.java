...
public class MapManager {
	...
	/**
	 * Méthode qui permet d'obtenir la nouvelle région
	 *
	 * @param anneeSim : Année de la simulation en cours
	 * @param evenementActuel : Evenement actuel en cours
	 *
	 * @return La région à afficher
	 */
	...
	/**
	 * Méthode qui permet de choisir la région
	 */
