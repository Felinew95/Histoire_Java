...
public class Economie {
    ...
    /** 
     * Montant total des revenus cumulés depuis le début de la simulation. 
     */
    private float gainsTotal = 0f;

    /** 
     * Montant total des dépenses et pertes cumulées depuis le début de la simulation. 
     */
    private float pertesTotal = 0f;
    ...
    /**
     * Retourne le montant cumulé des gains depuis le début de la simulation.
     * @return Le total des gains en {@code float}.
     */
    public float getGainsTotal() {
        return gainsTotal;
    }

    /**
     * Définit ou réinitialise le montant total des gains.
     * @param v La nouvelle valeur des gains totaux.
     */
    public void setGainsTotal(float v) {
        this.gainsTotal = v;
    }

    /**
     * Retourne le montant cumulé des pertes depuis le début de la simulation.
     * @return Le total des pertes en {@code float}.
     */
    public float getPertesTotal() {
        return pertesTotal;
    }

    /**
     * Définit ou réinitialise le montant total des pertes.
     * @param v La nouvelle valeur des pertes totales.
     */
    public void setPertesTotal(float v) {
        this.pertesTotal = v;
    }
