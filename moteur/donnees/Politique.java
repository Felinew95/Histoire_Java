...
/**
 * Classe qui présente une politique 
 * 
 * @author Massinissa
 * @version 1.0
 */
public class Politique {
    ...
    // Attributs
    private String typeRegime; // Type de régime politique (Monarchie, République, etc.)
     ...
     */
    public void setType_regime(String typeRegime) {
