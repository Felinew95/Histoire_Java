...
public class ArmeeManager {
     ...
     */
    public static void updateArmee(int anneeSim, Armee armee, Evenement evenement, String nomCivilisation) {
        if (armee == null) {
            return;
        }
        ...
        updateEtat(armee);
        updateChefArmee(armee, anneeSim, nomCivilisation);
    }

    /**
     * Met à jour le chef de l'armée selon l'année de simulation.
     */
    private static void updateChefArmee(Armee armee, int anneeSim, String nomCivilisation) {
        Kersir kersirArmee = CHEF_REPOSITORY.getKersirActuel(nomCivilisation,anneeSim);
        if (kersirArmee != null) {
